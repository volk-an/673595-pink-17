...
btnClose.classList.add('page-header__button--togle');
//btnOpen.classList.remove('page-header__button--togle');

btnOpen.addEventListener('click', function() {
  btnOpen.classList.add('page-header__button--togle');
  btnClose.classList.remove('page-header__button--togle');
